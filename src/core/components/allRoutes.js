...
export const allRoutes = () => ({
    guest: [
        ...
        { exact: true, path: '/playground', component: Playground }, 
        { exact: true, path: '/terms', component: Terms }, 
        { exact: true, path: '/policy', component: Policy }, 
        { exact: true, path: '/coin', component: CoinList }, 
        { exact: true, path: '/coin/new', component: AddCoinPage } 
    ],
    user: [
        { exact: true, path: '/', component: Playground }, 
        { exact: true, path: '/terms', component: Terms }, 
        { exact: true, path: '/policy', component: Policy }, 
        { exact: true, path: '/coin', component: CoinList }, 
        { exact: true, path: '/coin/new', component: AddCoinPage }, 
        { exact: true, path: '/user', component: UserPage }
    ],
    expert: [
        { exact: true, path: '/', component: Playground },
        { exact: true, path: '/terms', component: Terms }, 
